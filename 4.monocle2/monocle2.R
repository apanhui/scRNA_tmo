...
ggsave( "Trajectory.Sample.pdf", p1, width = 12, height = 10, limitsize = FALSE )
ggsave( "Trajectory.Sample.facet.pdf", p2, width = 18, height = 10, limitsize = FALSE )
p3 <- plot_cell_trajectory(mnc_obj, color_by = "Clusters",show_branch_points = F)
p4 <- p3 + facet_wrap(~Clusters,nrow = 1)
ggsave( "Trajectory.Cluster.pdf", p3, width = 12, height = 10, limitsize = FALSE )
ggsave( "Trajectory.Cluster.facet.pdf", p4, width = 18, height = 10, limitsize = FALSE )
p5 <- plot_cell_trajectory(mnc_obj, color_by = "State",show_branch_points = F)
p6 <- p5 + facet_wrap(~State,nrow = 1)
ggsave( "Trajectory.State.pdf", p5, width = 12, height = 10, limitsize = FALSE )
ggsave( "Trajectory.State.facet.pdf", p6, width = 18, height = 10, limitsize = FALSE )
p7 <- plot_cell_trajectory(mnc_obj, color_by = "Pseudotime", show_branch_points = F)
ggsave( "Trajectory.Pseudotime.pdf", p7, width = 12, height = 10, limitsize = FALSE )
